...
//                                : null);
                Log.d("Settings", "pref:" + preference.getKey() + " val" + value);
                if (preference.getKey().equals("default_efficiency")) {
                    Statistics.setDefault_efficiency(Integer.valueOf(String.valueOf(value)));
                }
                if (preference.getKey().equals("min_speed")) {
                    Statistics.setMin_speed(Integer.valueOf(
